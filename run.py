...
def validate_data(values):
    ...
    try:
        ...
        if len(values) != 6:
            raise ValueError(
                f"Exactly six value are required, you provided {len(values)}"
            )
...
def update_worksheet(data, worksheet):
    ...
    Update the relevant workseet with data provided 
    """
...
def get_last_5_entries_sales():
    ...
    collecting the last five entries for each sandwhich and returns 
    the data as a list
    """
